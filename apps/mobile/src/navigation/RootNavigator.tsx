...
import { DriverDocumentsScreen, DriverEarningsScreen, DriverHistoryScreen, DriverHomeScreen, DriverProfileScreen, DriverUnavailabilityScreen } from '../screens/driver/DashboardScreens';
